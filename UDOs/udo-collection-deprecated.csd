...
opcode sndfl_looper2,aa,SSSkkkkiik[]k[]k[]
...
opcode ctrl_arr,a,ak[]oo
  ...
  ;; input
  aIndex,kArr[],iNormOutput,iInterp xin 
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; karplus strong
opcode karplus,a,akk
  aIn,kTime,kFdbk xin
  setksmps 1

  kTime = kTime/sr
  aDUMP delayr 5
  aKarplusOut deltap kTime
  aKarplusFilt fir aKarplusOut
  delayw aIn+(aKarplusFilt*kFdbk)

  aOut limit aKarplusOut,-1,1
  xout aOut
endop
...
opcode stereo_enhancer, aa, aa
  aIn1, aIn2 xin
  seed 0
  kLowCF randomi 80,200,1
  kHiCF randomi 1000,155,1
  ;; mono-bass
  aLP1 butterlp aIn1, kLowCF
  aLP2 butterlp aIn2, kLowCF
  aLP sum aLP1*.5, aLP2*.5


  ;; wide-highs
  aHP1 butterhp aIn1, kHiCF
  aHP2 butterhp aIn2, kHiCF
  aHPleft1, aHPright1 pan2 aHP1, 0
  aHPleft2, aHPright2 pan2 aHP2, 1
  aHPleft sum aHPleft1, aHPleft2
  aHPright sum aHPright1, aHPright2

  ;; mids
  aMids1 butterhp aIn1, kLowCF
  aMids2 butterhp aIn2, kLowCF
  aMids1 butterlp aMids1, kHiCF
  aMids2 butterlp aMids2, kHiCF
  aMidsLeft1, aMidsRight1 pan2 aMids1, 0.25
  aMidsLeft2, aMidsRight2 pan2 aMids2, 0.75
  aMidsLeft sum aMidsLeft1, aMidsLeft2
  aMidsRight sum aMidsRight1, aMidsRight2
  
  aOut1 sum aLP, aHPleft, aMidsLeft,aIn1
  aOut2 sum aLP, aHPright, aMidsRight,aIn2
  aOut1 balance2 aOut1,aIn1
  aOut2 balance2 aOut2,aIn2
  xout aOut1, aOut2 
endop
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; Doom Compressor
opcode doom_cmpr,aa,aakkkkip
  ...
  aLimit1 clip aSum1,2,ampdbfs(-.3)
  aLimit2 clip aSum2,2,ampdbfs(-.3)
